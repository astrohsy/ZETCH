...
public class TestConstants {
  ...
  public static String USERNAME_1 = "bob";
  public static String USERNAME_2 = "cat";
  public static String DISPLAY_NAME_1 = "Bob";
  public static String DISPLAY_NAME_2 = "Cat";
  public static String LOCATION_NAME_1 = "Acme Restaurant";
  public static String LOCATION_NAME_2 = "Foo Museum";
  public static String EMAIL_1 = "bob@example.com";
  public static String EMAIL_2 = "cat@example.com";
  public static String COMMENT_1 = "It was a great experience";
  public static String COMMENT_2 = "I did not like it";
  public static String ADDRESS_1 = "155 Claremont NY";
  public static String ADDRESS_2 = "120 Broadway ";
  ...
  public static LocationEntity LOCATION_1 =
      LocationEntity.builder().name(LOCATION_NAME_1).address(ADDRESS_1).build();
