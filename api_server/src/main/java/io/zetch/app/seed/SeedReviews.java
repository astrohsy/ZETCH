...
public class SeedReviews {
  ...
  public static final ReviewEntity REVIEW19 =
      ReviewEntity.builder()
          .comment(
              "I was really looking forward to this but the endless flock of idiots taking selfies"
                  + " and droning around the place viewing everything through their phone made me"
                  + " want to vomit.")
          .rating(2)
          .user(SeedUsers.USER3)
  ...
  public static final ReviewEntity REVIEW26 =
      ReviewEntity.builder()
          .comment(
              "The permanent collection is wonderful and all, but the treatment of patrons was a"
                  + " joke…")
          .rating(2)
          .user(SeedUsers.USER5)
          .location(SeedLocations.LOCATION6)
  ...
  public static final ReviewEntity REVIEW27 =
      ReviewEntity.builder()
          .comment(
              "It was very disappointing that they “sold” us tickets for the same evening (first"
                  + " Friday of the month) that it was a “pay what you wish” hour. The museum was"
                  + " crazy busy. We couldn’t get close to a lot of famous art work because of the"
                  + " crowd.")
          .rating(3)
          .user(SeedUsers.USER6)
          .location(SeedLocations.LOCATION6)
  ...
  public static final ReviewEntity REVIEW32 =
      ReviewEntity.builder()
          .comment(
              "This is a must see.. check your coat it's warm inside. Place for umbrellas at the"
                  + " entrance. Fantastic collections. Nothing else to be said, this is an art"
                  + " museum that you shouldn't miss.")
          .rating(4)
          .user(SeedUsers.USER16)
          .location(SeedLocations.LOCATION6)
          .build();
  ...
  public static final ReviewEntity REVIEW24 =
      ReviewEntity.builder()
          .comment(
              "Absolutely phenomenal museum … so intimate and well-curated. It hurt my soul that it"
                  + " was free and so wonderfully put together, but it is nearly unknown even to"
                  + " native New Yorkers such as myself. Please set aside 30 minutes to tour this"
                  + " gem!")
          .rating(5)
          .user(SeedUsers.USER12)
          .location(SeedLocations.LOCATION6)
  ...
  public static final ReviewEntity REVIEW29 =
      ReviewEntity.builder()
          .comment(
              "We are so happy to have found this museum! Inguna at the front desk is such a gem."
                  + " If you have trouble getting up the stairs, do not come to this museum. We"
                  + " visited three times in one week!")
          .rating(5)
          .user(SeedUsers.USER13)
          .location(SeedLocations.LOCATION6)
          .build();
  ...
  public static final ReviewEntity REVIEW30 =
      ReviewEntity.builder()
          .comment(
              "Absolutely loved this museum! It's FREE and the artwork is incredible! I had never"
                  + " heard of the artist before coming here but I left as a fan of his work. More"
  ...
  public static final ReviewEntity REVIEW31 =
      ReviewEntity.builder()
          .comment(
              "This is an amazing place to visit in NYC. It's so perfectly meditative and the works"
                  + " of art are deep and meaningful. It glows with a sense of power that is subtle"
                  + " and beautiful.")
          .rating(5)
          .user(SeedUsers.USER15)
          .location(SeedLocations.LOCATION6)
  ...
  public static final ReviewEntity REVIEW34 =
      ReviewEntity.builder()
          .comment(
              "I have to give it 5 stars. I mean, the collection is insane. This is on my top 3"
                  + " museums globally. However, it is a lot. You will get super tired and spend a"
                  + " lot of time if you like art. I would recommend starting from up to down and"
                  + " taking a break.")
          .rating(5)
  ...
  public static final ReviewEntity REVIEW35 =
      ReviewEntity.builder()
          .comment(
              "One of the best museums I ever visited. Huge collection. Maybe the only thing that"
                  + " is missing is a printed map of the floors and relative collections.")
          .rating(5)
