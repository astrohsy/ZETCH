...
public class LogController {
  ...
  @GetMapping("/{clientId}")
  @Operation(summary = "Retrieve all logs for the user's client. Auth: user has to belong to the client.")
  ...
  @Operation(summary = "Delete all logs for the user's client. Auth: user has to belong to the client.")
  @SecurityRequirement(name = "OAuth2")
  @PreAuthorize("@securityService.isSelfClient(#token, #clientId)")
  @Transactional
